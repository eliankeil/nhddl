...
EE_OBJS += gui.o gui_graphics.o gui_args.o gui_skin.o gui_icons.o gui_frames.o pad.o
EE_OBJS += devices.o devices_mmce.o devices_bdm.o devices_iso.o devices_hdl.o devices_elf.o
