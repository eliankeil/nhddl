...
const FrameIcon FRAME_PARTS[] = {
    {103, 26, 10, 10},   // FRAME_CORNER_TL
    {117, 26, 10, 10},   // FRAME_CORNER_TR
    {103, 40, 10, 10},   // FRAME_CORNER_BL
    {117, 40, 10, 10},   // FRAME_CORNER_BR
    {113, 26, 4, 3},   // FRAME_EDGE_TOP
    {113, 47, 4, 3},   // FRAME_EDGE_BOTTOM
    {103, 36, 3, 4},   // FRAME_EDGE_LEFT
    {124, 36, 3, 4}    // FRAME_EDGE_RIGHT
};
